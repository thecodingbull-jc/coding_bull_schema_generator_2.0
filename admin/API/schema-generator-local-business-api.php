...
function homepage_generate_schema( $silent = false ){
    ...
    // The agency creator credit that used to be built here now lives in the TCB
    // Elementor Widgets plugin, which emits it on every page against a stable
    // agency @id. Nothing writes homepage_website_jsonld_script any more.
